    ...
    <body id="page-top">
        ...
        <div id="wrapper">
            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <!-- Sidebar - Brand -->
                <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<%= request.getContextPath()%>/vista/encargado/index.jsp">        
            ...
            <div id="content-wrapper" class="d-flex flex-column" ">
                ...
                <div id="content" class="d-flex p-2">
                    <img class="img-fluid img-thumbnail" src="<%= request.getContextPath()%>/recursos/img/fondo_encargado.jpg" alt=""/>
                    <!-- Begin Page Content -->
